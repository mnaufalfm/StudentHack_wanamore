    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                Log.d("Main3Activity", "onAuthStateChanged");
                ...
                if (user != null) {
                    ...
                    if (user.getPhotoUrl() != null) {
                        Log.d("Main3Activity", "photoURL: " + user.getPhotoUrl());
                        Picasso.with(Main3Activity.this).load(user.getPhotoUrl()).into(imageView);
                    }
                } else {
                    //user auth state is not existed or closed, return to Login activity
                    startActivity(new Intent(Main3Activity.this, com.example.android.studenthack_wanamore.view.LoginActivity.class));
                    finish();
                }
            }
        };
